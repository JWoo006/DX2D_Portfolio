...
namespace jw
{
	FactoryScene_03::FactoryScene_03()
	{
		SetName(L"FactoryScene_03");
	}
	FactoryScene_03::~FactoryScene_03()
	{
	}
	void FactoryScene_03::Initialize()
	{
		//UI
		{
			// hud_base
		...
		//bg
		{
			...
			mr->SetMesh(Resources::Find<Mesh>(L"RectMesh"));
			mr->SetMaterial(Resources::Find<Material>(L"SpriteMaterial_Room_Factory_3"));
	...
	void FactoryScene_03::Update()
	{
		Scene::Update();

		if (Input::GetKeyDown(eKeyCode::N))
		{
			SceneManager::LoadScene(L"FactoryScene_03_2");
		}
	}

	void FactoryScene_03::LateUpdate()
	{
		Scene::LateUpdate();
	}

	void FactoryScene_03::Render()
	{
		Scene::Render();
	}
}